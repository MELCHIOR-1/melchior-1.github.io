...
2、不带后台，数据直接存储在浏览器storage中，比如[StackEdit](https://stackedit.io/app#)、[doocs](https://github.com/doocs/md)、
...
s1MjM2NjM2MDAsLTQ2NjgzMzk5LDEyOTU2MTg4NDEsLTY3NjQw
NTQxNiw4NTAyMzU1MywyMTI3MzA0NjI1LDE4MDM4NTc4NzBdfQ
==
-->